...
**A. En este gráfico se compara la relacion de cómo interfiere la isla y la especie, en los picos de los pingüinos (Largo y ancho) gracias a la presencia de la línea de regresión lineal**
**B) En este caso mediante un diagrama de caja se indica la relación específica entre la especie de pingüinos vs el pico con respecto a la anchura. Un diagrama de caja muestra la distribución de un conjunto de datos a lo largo de un eje numérico. Cada caja representa el rango intercuartílico (IQR) de los datos, que es la distanciEn este diagrama se puede interpetar como la comparación entre la longitud de los picos de los pingüinos vs el sexo de entre sus diferentes especies (Machos y hembras)**
**Es así que se deduce que los machos tienden a tener picos más largos que las hembras**.
...
**INTERPRETACIÓN**
**En el primer gráfico se muestra un jitter plot, donde los puntos son un pingüino, pero su ubicación, en el eje x indica su especie y el de las y el tamaño de su pico. Como resultado se obtuvo que los pingüinos con picos más largos se encontraron arriba, y los de picos más cortos, abajo.**

**El segundo, relaciona a los datos de los picos para cada especie y sexo, en términos de cuartiles. Aquí, los valores que más se alejan a la mayoría de datos se encuentran fuera de los bigotes.** 
...
**INTERPRETACIÓN:** 
**Este mapa de calor muestra las rlaciones entre dos tipos de suero, (uno llamado HSS y el otro HSIS)con el tiempo y la distancia; mientras mayor sea la distancia, mayor será la interacción entre el suero con respecto al tiempo. De este modo, se deduce que el suero HSS tiene una mejor reacción al cabo de las 48 horas, pero puede llegar a una distancia aproximadamente de 100 a las 24 horas. Por el contrario, el suero HSIS solo reacciona a las 48 horas pero puede llegar a tener una distancia de 150**
